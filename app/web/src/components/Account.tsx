    ...
    return (
        <div className='bg-linear-to-r from-red-700 via-yellow-300 via-green-500 to-blue-700 p-0.5 rounded-md'>
            <div className='bg-white rounded-sm'>
                <button className='cursor-pointer bg-clip-text bg-gray-900 rounded-md p-2 rounded-xs flex items-center gap-2 text-transparent transition hover:bg-linear-to-r hover:from-red-700 hover:via-yellow-600 hover:via-green-700  hover:to-blue-700'>
